...
extern "C" {
		...
		*/
		...
		/** @brief Write an RAW bulk report to a HID device.
		...
		*/
		...
		int  HID_API_EXPORT HID_API_CALL hid_raw_bulk_write(hid_device *device, const unsigned char *data, size_t length);
